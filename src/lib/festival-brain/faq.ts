...
export const FAQ: Record<FaqKey, FaqEntry> = {
  ...
  vendor_part_payment: {
    ...
    answer:
      'Could you manage the full stall fee by 15 October 2026? Paying sooner really helps us put on the best possible show for you. If a single payment is not possible, we can set up a payment plan of one or two payments (a third only if you truly need it), with the last one by 15 October 2026, or 1 November, then 15 November, and 30 November 2026 at the very latest. Tell me the amount and exact date of each instalment and I will submit it for approval. You pay each one by EFT and send your proof to support@youngatheart.co.za. Until your plan is approved, your current due date still stands and you will still receive the reminder emails.',
  },
  vendor_invoice_vat: {
