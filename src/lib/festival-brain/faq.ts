...
export const FAQ: Record<FaqKey, FaqEntry> = {
  ...
  vendor_part_payment: {
    ...
    fact:
      'We always encourage a vendor to settle their full stall fee as soon as they can, ideally in full by the end of September 2026, because paying sooner helps the organisers put on the best possible show (locking in the marquee, power and marketing). We push at least twice for them to pay as much as they can this month before offering any plan, always steering to one or two payments. If a single payment is not possible, we can set up a payment plan of two instalments (a third only as an absolute last resort), with the final instalment by 15 October 2026 for this round, and 31 October 2026 at the very latest. They propose the exact date and amount of each instalment, it is approved automatically a few minutes later, and instalments are paid by EFT with the proof sent to support@youngatheart.co.za (a card checkout takes the full amount at once). Until a plan is approved or the fee is settled, the current due date of the vendor still stands and they still receive the payment reminder emails.',
    ...
    answer:
      'Could you manage the full stall fee by the end of September 2026? Paying sooner really helps us put on the best possible show for you. If the full amount this month is tight, how much can you pay now, and we settle the rest on a short plan? If a single payment is not possible, we can set up a payment plan of one or two payments (a third only if you truly need it), with the last one by 15 October 2026 for this round, and 31 October 2026 at the very latest. Tell me the amount and exact date of each instalment and I will submit it for approval. You pay each one by EFT and send your proof to support@youngatheart.co.za. Until your plan is approved, your current due date still stands and you will still receive the reminder emails.',
  },
  vendor_invoice_vat: {
