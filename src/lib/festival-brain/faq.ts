...
export const FAQ: Record<FaqKey, FaqEntry> = {
  ...
  vendor_part_payment: {
    ...
    fact:
      'We always encourage a vendor to settle their full stall fee by the end of September 2026 first, because paying earlier helps the organisers put on the best possible show (locking in the marquee, power and marketing). If a single payment this month is not possible, we can set up a payment plan: two instalments by default (a third on request), with the final instalment by the end of October 2026, or mid-November, and 30 November 2026 at the very latest. They propose the exact date and amount of each instalment, it is approved automatically a few minutes later, and instalments are paid by EFT with the proof sent to support@youngatheart.co.za (a card checkout takes the full amount at once). Until a plan is approved or the fee is settled, the current due date of the vendor still stands and they still receive the payment reminder emails.',
    ...
    answer:
      'Could you manage the full stall fee by the end of September 2026? Paying earlier really helps us put on the best possible show for you. If this month is not possible, we can set up a payment plan: two instalments (or three if you need), with the last one by the end of October 2026, or mid-November, and 30 November 2026 at the very latest. Tell me the amount and exact date of each instalment and I will submit it for approval. You pay each one by EFT and send your proof to support@youngatheart.co.za. Until your plan is approved, your current due date still stands and you will still receive the reminder emails.',
  },
  vendor_invoice_vat: {
