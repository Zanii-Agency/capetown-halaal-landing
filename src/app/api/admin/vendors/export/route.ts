...
export async function GET(req: NextRequest) {
  ...
  let q = db
    ...
    .select('id, business_name, contact_name, email, phone, product_categories, business_description, preferred_booth_tier, special_requirements, status, admin_notes, contract_signed_at, contract_pdf_path')
