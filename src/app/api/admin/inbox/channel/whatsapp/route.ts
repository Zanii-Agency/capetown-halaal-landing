// WhatsApp channel list. Reads ONLY its own tables (see lib/inbox/channel-threads.ts):
...
import { loadWhatsAppThreads } from '@/lib/inbox/channel-threads'
...
export async function GET() {
  ...
  const threads = await loadWhatsAppThreads(user.email)
