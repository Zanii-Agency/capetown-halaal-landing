// Gmail (Samreen's capetownhalaal@gmail.com) channel list. Reads ONLY its own tables (see lib/inbox/channel-threads.ts):
...
export async function GET() {
  ...
  const threads = await loadMailThreads(user.email, 'gmail')
